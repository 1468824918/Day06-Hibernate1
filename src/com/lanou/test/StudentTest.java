...
public class StudentTest {
    /*session的工厂类对象,是线程安全的,一个数据库对应一个session工程类对象*/
    /*
        通常在项目启动时初始化该对象,用Configuration对象创建
    */
    ...
    /*事务对象,与jdbc中的事务类似,只不过hibernate中的事务是不自动提交的,而jdbc中的
    * 事务是会自动提交的,hibernate中的事务需要手动提交
    * */
    private Transaction transaction;

    /**
     * 初始化操作
     * Before注解:在Test注解之前执行的方法,通常该方法中做一些初始化操作
     */
    @Before
    public void init(){
    ...
    /**
     * 数据库销毁操作
     * After注解:在Test注解之后执行的方法,通常该方法做一些释放,关闭的操作
     */
    @After
    public void destroy(){
    ...
    public void createCriteria(){
        //获得要进行查询的Student对应Criteria接口对象 它是比HQL更加高级的查询方式
